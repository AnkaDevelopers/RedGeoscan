...
def redGeoscan(ruta_archivos_excel, ruta_proyecto, nombre_proyecto, radio):
    ...
    msj_depuracion, diccionario_antenas_con_rinex = actualizar_diccionario_con_rinex_antenas(diccionario_antenas_con_administrador)
    ...
    msj_depuracion, diccionario_antenas_con_coordenada = actualizar_diccionario_con_coordenada(diccionario_con_informacion_final_proyecto)
    ...
    msj_depuracion, resultado_informes = generar_informe_pdf_por_gps(diccionario_con_informacion_final_proyecto, radio)    
