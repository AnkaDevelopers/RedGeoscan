...
<sld:StyledLayerDescriptor version="1.0.0" xmlns:sld="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink">
  <sld:NamedLayer>
    <sld:Name>6CambioLatitud</sld:Name>
    <sld:UserStyle>
      <sld:Name>Style1</sld:Name>
      <sld:FeatureTypeStyle>
        <sld:FeatureTypeName>6CambioLatitud</sld:FeatureTypeName>
        <sld:Rule>
          <sld:Name>6CambioLatitud</sld:Name>
          <sld:Title>6CambioLatitud</sld:Title>
          <sld:LineSymbolizer>
            <sld:Stroke>
          ...
          <sld:TextSymbolizer>
            <sld:Label>
              <ogc:PropertyName>Latitud</ogc:PropertyName>
            </sld:Label>
            <sld:Font>
           ...
           <PointPlacement>
			 ...
			 <Rotation>0</Rotation>
             <Displacement>
               <DisplacementX>230</DisplacementX>
