      ...
      <sld:FeatureTypeStyle>
        ...
        <sld:Rule>
          ...
          <sld:PolygonSymbolizer>
            <sld:Fill>
              <sld:CssParameter name="fill">#ed6868</sld:CssParameter>
              <sld:CssParameter name="fill-opacity">0.3</sld:CssParameter>
            </sld:Fill>
            <sld:Stroke>
              <sld:CssParameter name="stroke">#ed6868</sld:CssParameter>
	  ...
	  <TextSymbolizer>
	    <Label>
	      ...
	      <CssParameter name="font-weight">normal</CssParameter>
			 ...
			 <sld:Fill>
              <sld:CssParameter name="fill">#961515</sld:CssParameter>
