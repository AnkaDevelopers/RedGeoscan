...
def conver_ctm12 ():
    ...
    imagenes_conversion_elipsoidal_decimal = {
    r"C:\RedGeoscan\geoepoca\Imagenes\coversion-y-transformacion\1.PNG",
    r"C:\RedGeoscan\geoepoca\Imagenes\coversion-y-transformacion\2.PNG",
    r"C:\RedGeoscan\geoepoca\Imagenes\coversion-y-transformacion\3.PNG",
    r"C:\RedGeoscan\geoepoca\Imagenes\coversion-y-transformacion\4.PNG",
    r"C:\RedGeoscan\geoepoca\Imagenes\coversion-y-transformacion\5.PNG",
    ...
    busqueda = buscar_y_click_en_set_imagenes(imagenes_conversion_elipsoidal_decimal, sensibilidad = 0.95)
        
    # segundo inteto busqueda de imagen
    if not busqueda:
        print("⚠ No se encontró el botón de conversion y transformación.")
            
        busqueda = buscar_y_click_en_set_imagenes(imagenes_conversion_elipsoidal_decimal, sensibilidad = 0.9)
    ...
    #***************************************************************************************
    # Data set de icono de carga archivo conversion y transformación.
    imagenes_archivo_conversion_elipsoidal_decimal = {
    r"C:\RedGeoscan\geoepoca\Imagenes\conversion-y-transformacion-archivo\1.PNG",
    r"C:\RedGeoscan\geoepoca\Imagenes\conversion-y-transformacion-archivo\2.PNG",
    r"C:\RedGeoscan\geoepoca\Imagenes\conversion-y-transformacion-archivo\3.PNG",
    r"C:\RedGeoscan\geoepoca\Imagenes\conversion-y-transformacion-archivo\4.PNG",
    r"C:\RedGeoscan\geoepoca\Imagenes\conversion-y-transformacion-archivo\5.PNG",
    }
        
    # Buscar Boton para desplegar el formulario de carga archivo conversion y transformación.
    busqueda = buscar_y_click_en_set_imagenes(imagenes_archivo_conversion_elipsoidal_decimal, sensibilidad = 0.9)
        
    # segundo inteto busqueda de imagen
    if not busqueda:
        print("⚠ No se encontró el botón de archivo conversion y transformación..")
            
        busqueda = buscar_y_click_en_set_imagenes(imagenes_archivo_conversion_elipsoidal_decimal, sensibilidad = 0.9)
            
        if not busqueda:
            msj_depuracion = "❌ No se encontro el icono de archivo conversion y transformación."
            print(msj_depuracion)
            return None, msj_depuracion
    ...
    #***************************************************************************************
    # Seleccion ruta donde se guardara el excel en CTM12
    pyautogui.press('tab', presses=3, interval=0.1)
    pyautogui.press('enter')
    #***************************************************************************************
    # Seleccionar Cargar equipo:
    ...
    pyautogui.press('enter')
    time.sleep(0.2) 
    # Selección de carpeta 2018-CTM12
    pyautogui.press('space')
    pyautogui.press('down', presses=3, interval=0.1)
    pyautogui.press('enter')
    time.sleep(0.2) 
    ...
    #***************************************************************************************
    msj = "✅ Archivo excel con conversion de 2018 a 2018-CTM12"
    print(msj)
    return True, msj
